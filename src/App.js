              ...
              <Switch>
                ...
                <Route exact path="/Countries-Dashboard-App">
                  <div style={this.state.themeOptions}>
                    <GoBack />
                    <CountriesDashboardApp styles={this.state.themeOptions}
                ...
                <Route exact path="/Countries-Dashboard-App/:countrydetails">
                  <div style={this.state.themeOptions}>
                    <CountryDetails styles={this.state.themeOptions}
                    onChangeTheme={this.onChangeTheme}  />
                  </div>
                </Route>
                ...
                <Route exact path="/grid-game">
                  <StyledTheme bg={selectTheme.themeStyle.background}
                  color={selectTheme.themeStyle.color}>
                  <GridMemoryGame/>
                  </StyledTheme>
                </Route>
